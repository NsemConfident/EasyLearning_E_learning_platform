...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        'disk' => env('LIVEWIRE_TEMPORARY_FILE_UPLOAD_DISK', 'public'), // Use 'public' so temp dir is under storage/app/public
        'rules' => ['required', 'file', 'max:20480'],         // 20MB max for Past Question PDFs (was default 12MB)
        ...
        'max_upload_time' => 10, // Max duration (in minutes) – increased for large PDFs / slow connections...
